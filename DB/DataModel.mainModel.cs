...
namespace RealCommerce.DB
{
    ...
    public partial class mainModel : DbContext
    {
        ...
        protected override void OnConfiguring(DbContextOptionsBuilder optionsBuilder)
        {
            ...
            {
              optionsBuilder.UseSqlite(Utils.GetConfigByName<string>("ConnectionString"));
            }
        ...
        private void CityMapping(ModelBuilder modelBuilder)
        {
            ...
            modelBuilder.Entity<City>().Property(x => x.Id).HasColumnName(@"Id").HasColumnType(@"INTEGER").IsRequired().ValueGeneratedNever();
